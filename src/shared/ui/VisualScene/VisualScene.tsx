 ...
 */
export function VisualScene({ color, type }: VisualSceneProps) {
    ...
    return (
        <div
            ...
            aria-hidden="true"
        >
            {/* Canvas: 3D 그래픽을 그리는 도화지입니다. 확장된 크기로 원자가 프레임 밖으로 멀리 날아갈 수 있게 합니다. */}
            <Canvas
                ...
                style={{
                    ...
                    width: '400%',
                    height: '300%',
                    zIndex: 10, // 텍스트보다 위에 표시
                    pointerEvents: 'auto', // 상호작용을 위해 다시 활성화
                }}
            >
                <ThreeErrorBoundary>
                    ...
                    <Float speed={2} rotationIntensity={controlsEnabled ? 0.5 : 0} floatIntensity={controlsEnabled ? 1 : 0}>
